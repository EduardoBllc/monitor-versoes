...
def test_lock_store_escrever_e_ler():
    g = FakeGit()
...
def test_lock_store_reconstruir_reagrupa_por_trailer():
    g = FakeGit()
...
def test_lock_store_reconstruir_retorna_orfaos_de_julgamento():
    g = FakeGit()
...
def test_lock_store_reconstruir_ordena_commits_por_data():
    g = FakeGit()
    t0 = datetime.datetime.now(datetime.timezone.utc)
